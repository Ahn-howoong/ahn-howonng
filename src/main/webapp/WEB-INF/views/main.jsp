...
<body>
    ...
    <div class="background1">
        <div class="box">
            <div id="search">
                <div>
                  <span>통합검색</span>
                  <input name="search" placeholder="도서명 또는 저자명을 입력해주세요" style="width:410px; height:50px; border:none;">
          ...
          <div class="box">
              	 ...
              	 <c:choose>
				    ...
				    <div class="login">
	                  ...
	                  <form>
	                      ...
	                      <p><a href="regi_form.do">회원가입</a></p>
	                  </form>
	                  </div>
		              <div class="mypage">
		                <h5>나의 도서관</h5>
				    ...
				    <c:otherwise>
						 <div class="login">
			            <h4><span>${user.name}</span>님 환영합니다</h4>
			            <hr>
			            <ul>
			              <li><a href="#">나의 서재</a></li>
			              <li><a href="checkout_return.html">대출조회/반납연기</a></li>
			          ...
			          <div class="mypage">
			            <img align="center" src="${pageContext.request.contextPath}/resources/img/review_icon.png">
			          </div>
				    </c:otherwise>
				</c:choose>  
            </div>
            <div class="box2">
              <div id="carouselExampleSlidesOnly" class="carousel slide slider1" data-ride="carousel">
                  <div class="carousel-inner">
                    <div class="carousel-item active">
                      <img class="d-block w-100" src="${pageContext.request.contextPath}/resources/img/text1.png" alt="First slide">
                    </div>
                    <div class="carousel-item">
                      <img class="d-block w-100" src="${pageContext.request.contextPath}/resources/img/text2.png" alt="Second slide">
                    </div>
                    <div class="carousel-item">
                      <img class="d-block w-100" src="${pageContext.request.contextPath}/resources/img/text3.png" alt="Third slide">
                    </div>
                  </div>
              </div>
            </div>
            <div class="box3">
              <table border="1" bordercolor="#ccc">
                <tr>
                  <td><a href="checkout_return.html"><img src="${pageContext.request.contextPath}/resources/img/icon1.png"></a></td>
                  <td><a href="join.html"><img src="${pageContext.request.contextPath}/resources/img/icon2.png"></a></td>
                </tr>
                <tr>
                  <td><a href="info.html"><img src="${pageContext.request.contextPath}/resources/img/icon3.png"></a></td>
                  <td><a href="project.html"><img src="${pageContext.request.contextPath}/resources/img/icon4.png"></a></td>
                </tr>
              </table>
                <a href="mbti.html"><img src="${pageContext.request.contextPath}/resources/img/mbti_logo.png" style="float:right;"></a>
            </div>
        </div>
    </div>
    ...
    <section class="box">
      <div id="carouselExampleIndicators" class="carousel slide slider2" data-ride="carousel">
        ...
        <div class="carousel-inner">
          <div class="carousel-item active">
            <img class="d-block w-100" src="${pageContext.request.contextPath}/resources/img/poster1.png" alt="First slide">
          </div>
          <div class="carousel-item">
            <img class="d-block w-100" src="${pageContext.request.contextPath}/resources/img/poster2.png" alt="Second slide">
          </div>
          <div class="carousel-item">
            <img class="d-block w-100" src="${pageContext.request.contextPath}/resources/img/poster3.png" alt="Third slide">
          </div>
        </div>
      ...
      <div class="notice">
        ...
        <div id="tab-1" class="tab-content current">
          <a href="#">&lt;<b>책벌레 클럽 주최</b>&gt; 월간 독서 모임</a><br>
          <a href="#">&lt;<b>2022 여름 북토크</b>&gt; 이만큼 가까이 - 정세랑</a><br>
          <a href="#">&lt;<b>2022 서울 북스타트</b>&gt; 영유아 책 꾸러미 선물 증정</a><br>
          <a href="#">&lt;<b>책벌레 클럽 주최</b>&gt; 월간 독서 모임</a><br>
          <a href="#">&lt;<b>2022 여름 북토크</b>&gt; 이만큼 가까이 - 정세랑</a><br>
          <a href="#">&lt;<b>2022 서울 북스타트</b>&gt; 영유아 책 꾸러미 선물 증정</a><br>
          <a href="#">&lt;<b>2022 서울 북스타트</b>&gt; 영유아 책 꾸러미 선물 증정</a>
        </div>
        <div id="tab-2" class="tab-content">
          <a href="#"><b>[문화강좌]</b> 2022년 4기(10~12월) 문화강좌 회원 모집</a><br>
          <a href="#"><b>[문화강좌]</b> 2022년 3기(7~9월) 문화강좌 회원 모집</a><br>
          <a href="#"><b>[문화강좌]</b> 2022년 2기(4~6월) 문화강좌 회원 모집</a><br>
          <a href="#"><b>[문화강좌]</b> 2022년 1기(2-3월) 문화강좌 회원 모집</a><br>
          <a href="#"><b>[문화강좌]</b> 2022년 4기(10~12월) 문화강좌 회원 모집</a><br>
          <a href="#"><b>[문화강좌]</b> 2022년 3기(7~9월) 문화강좌 회원 모집</a><br>
          <a href="#"><b>[문화강좌]</b> 2022년 2기(4~6월) 문화강좌 회원 모집</a><br>
        </div>
        <div id="tab-3" class="tab-content">
          <a href="#"><b>[독서문화프로그램]</b> 직장인을 위한 레벨업 프로젝트</a><br>
          <a href="#"><b>[2022책축제]</b> 창작 인형극</a><br>
          <a href="#"><b>[2022책축제]</b> 그림책극장 체험키트 신청</a><br>
          <a href="#"><b>[독서문화프로그램]</b> 직장인을 위한 레벨업 프로젝트</a><br>
          <a href="#"><b>[2022책축제]</b> 창작 인형극</a><br>
          <a href="#"><b>[2022책축제]</b> 그림책극장 체험키트 신청</a><br>
          <a href="#"><b>[2022책축제]</b> 그림책극장 체험키트 신청</a><br>
