...
$(document).ready(function () {
    ...
    $.ajax({
            ...
            .done(function (msg) {
                ...
                for(var i=0; i<12; i++) {
                    var str = "<ul><li><a herf='search.do?";
                    str += msg.item[i].title
                    str += "'><img src='";
                    str += msg.item[i].cover;
                    str += "' class='zoom'></a></li><li><a herf='search.do?";
                    str += msg.item[i].title;
                    str += "'>";
                    str += msg.item[i].title.substr(0, 10);;
                    str += "</a></li><li><a herf='search.do?";
                    str += msg.item[i].title;
                    str += "'>";
                    str += msg.item[i].author.substr(0, 10);
                    str += "</a></li></ul>";
                    $("#tab-1").append(str);
                }
